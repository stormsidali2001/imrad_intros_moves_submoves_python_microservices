...
moves_classification_model_path = 'model_data_1_submoves'; 
...
async def startup(app: FastAPI):
    client = EurekaClient(eureka_server=eureka_server_url, app_name="ai_model_moves_move1", instance_port=8002)
    await client.start()
    yield
    # Shutdown code here
